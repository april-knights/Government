...
1. This new Battalion Commander is selected in the same method as all other Commanders, through Upper Council vote and confirmation.
...
1. Actions allowed include muting, kicking, or access restriction to individual or individuals failing to maintain discipline and decorum in accordance with posted rules.

## Section 2
1. Arbiters are granted access to most officially April Knight sponsored communication platforms
1. This does not include access to platforms dedicated to sub-groups within the Order
1. This access includes both the Upper and Lower Council chambers, whether for discussion or voting.
...
1. As such, the Arbiters are the only Battalion to not have Lower Council representation.
1. This restriction in no way shape or form places any limitation on any Arbiter’s right to vote in Order wide polling, e.g. the Grandmaster elections.
